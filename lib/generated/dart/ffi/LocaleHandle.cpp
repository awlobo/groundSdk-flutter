...
library_locale_create_handle(const char* language_code,
    ...
    auto language_code_optional = language_code != nullptr
        ? ::optional<std::string>(std::string(language_code))
        : ::optional<std::string>();
    auto country_code_optional = country_code != nullptr
        ? ::optional<std::string>(std::string(country_code))
        : ::optional<std::string>();
    auto script_code_optional = script_code != nullptr
        ? ::optional<std::string>(std::string(script_code))
        : ::optional<std::string>();
    auto language_tag_optional = language_tag != nullptr
        ? ::optional<std::string>(std::string(language_tag))
        : ::optional<std::string>();
